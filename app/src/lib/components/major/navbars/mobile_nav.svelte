<nav class="mobile_nav flex_row main_bg w-full">
    ...
    <li class="mobile_links flex_row secondary_txt ">
        ...
        <ul class="mobile_link"><a href="#" class= " tertiary_txt_hover">Esports</a></ul>
        <ul class="mobile_link"><a href="#" class= " tertiary_txt_hover">Stores</a></ul>
        <ul class="mobile_link"><a href="#" class= " tertiary_txt_hover">Blog</a></ul>
    </li>
</nav>
